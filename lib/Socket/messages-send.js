...
const SpencerStatus = require("./gcstatus");
...
const makeMessagesSocket = (config) => {
    ...
    const spencerStatus = new SpencerStatus(Utils_1, waUploadToServer, relayMessage, config, sock);
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (
                ...
                return await spencerStatus.handleGroupStory(content, jid, options.quoted);
            } else {
